...
function About() {
    return (
        <>
            <section id='about' className='container px-10 mt-16 mx-auto lg:mt-36'>
                <div className='grid grid-cols-1 gap-y-7 lg:grid-cols-2 gap-x-4'>
                    ...
                    <div>
                        ...
                        <p className='text-lg text-gray-700 mt-2 mb-3'>
                            I am actively involved in the digital space and love to share insights and updates on my GitHub and Instagram, where I explore some random topics and find a new friend. You can find me on Instagram at <span className='font-semibold'>@dimasbajuri</span>, where I share my thoughts on Hobby, my newest projects, etc. Let's connect and engage in meaningful conversations!
                        </p>
                        <div className='flex gap-x-3'>
                            <a target='_blank' href="https://www.instagram.com/dimasbajuri/" className='w-10 rounded-full border flex justify-center items-center h-10 text-dark border-dark hover:bg-dark hover:text-bright text-lg'>
                                <FontAwesomeIcon icon="fa-brands fa-instagram" />
                            </a>
                            <a target='_blank' href="https://github.com/dimasbajuri" className='w-10 rounded-full border flex justify-center items-center h-10 text-dark border-dark hover:bg-dark hover:text-bright text-lg'>
