    ...
    return (
        <>
            <section id='home' className='container px-10 pt-20 mx-auto lg:pt-36 lg:h-[90dvh]'>
                <div className='w-full grid grid-cols-1 items-center justify-items-center gap-8 lg:grid-cols-2 lg:gap-0'>
                    <div>
                        <h4 className='text-lg mb-1 text-primary font-semibold'>Welcome to My Website👋</h4>
                        <h2 className='lg:text-5xl text-4xl font-bold mb-1 uppercase'><span className='hidden lg:contents'>I'm</span> Dimas Rizki</h2>
                    ...
                    <div className='lg:justify-self-center'>
                        <div className='w-80 h-80 rounded-full bg-dark'></div>
                    </div>
                </div>
            </section>
        </>
